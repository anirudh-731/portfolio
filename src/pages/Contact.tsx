          ...
          >
            ...
            <div>
              ...
              <div className="space-y-4">
                {contactInfo.map((info, index) => (
                  ...
                  >
                    <Card className="gradient-card p-6 hover:glow-primary transition-all duration-300">
                ...
                {socialLinks.map((social, index) => (
                  ...
                  >
                    <Button
                      variant="outline"
                      size="icon"
                      className="w-12 h-12 border-primary text-primary hover:bg-primary hover:text-primary-foreground transition-all hover:scale-110"
                      asChild
                    >
                      <a 
                        href={social.href} 
            ...
            <Card className="gradient-card p-6">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-neon-green font-medium">Available for hire</span>
              </div>
            </Card>
          </motion.div>
        </div>
